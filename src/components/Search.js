...
export default class Search extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      allData: [
        {
          ...
          img: (
            <img
              class="img-books"
              src="https://cdn.waterstones.com/bookjackets/large/9781/1195/9781119515968.jpg"
            ></img>
          ),
          author: "Jane Holcomb",
          summary:
...

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://images-na.ssl-images-amazon.com/images/I/51po-MUjjEL._SX328_BO1,204,203,200_.jpg"
            />
          ),
          author: "Imad Abbadi",
          summary:
...

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/2590/9781259025952.jpg"
            />
          ),
          author: "John Dean",
...

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://images-na.ssl-images-amazon.com/images/I/51KKeH0XKKL._SX379_BO1,204,203,200_.jpg"
            />
          ),
          author: "S. A. Kelkar",
          summary:
            " Here is a comprehensive book that serves as a one-stop overview forunderstanding, developing, and deploying Information Systems. It aimsto provide the students with a conceptual framework to understand InformationSystems (IS) "
        },

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://images-eu.ssl-images-amazon.com/images/I/51yuIWZHm9L._SX260_.jpg"
            />
          ),
          author: "Gary Dessler",
          summary:
...

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://images-na.ssl-images-amazon.com/images/I/51bJeOEvg-L._SX366_BO1,204,203,200_.jpg"
            />
          ),
          author: "Paul Baines",
          summary:
...

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://images-na.ssl-images-amazon.com/images/I/61gOjYQqdYL._AC_SY400_.jpg"
            />
          ),
          author: " John Wild ",
          summary:
...

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9780/4140/9780414023253.jpg"
            />
          ),
          author: "Jason Chuah",
          summary:
...

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://prodimage.images-bn.com/pimages/9780415723060_p0_v2_s550x406.jpg"
            />
          ),
          author: " David Kelly ",
          summary:
            " Business Law offers comprehensive coverage of the key aspects of business law in a straightforward manner that is easy to understand for non-law students. "
        },

        {
          ...
          img: (
            <img
              class="img-books"
              src="https://global.oup.com/academic/covers/pdp/9780198802525"
            />
          ),
          author: " Jonathan Law",
          summary:
      ...
      searchData: [] //new array to search
    };
  }
  ...
  handleSubmit = event => {
    ...
    //to take input from user and search and add to search data
    let newData = this.state.allData.filter(book => {
